...
public class OrderLoaderTest {
    ...
    class GetOrderByOrderIdTests {
        ...
        void ORDER_NOT_FOUND_ResourceNotFoundException() {
            ...
            ResourceNotFoundException exception = assertThrows(ResourceNotFoundException.class,
                () -> orderLoader.getOrderByOrderId(orderId));
        ...
        void getOrderByOrderId_성공() {
            ...
            // when
            Order result = orderLoader.getOrderByOrderId(orderId);
    ...
    class GetOrderProductByOrderIdTests {
        ...
        void getOrderProductByOrderId_성공() {
            ...
            // when
            List<OrderProduct> result = orderLoader.getOrderProductByOrderId(orderId);
    ...
    class CreateOrderTests {
        ...
        void createOrder_성공() {
            ...
            // when
            Order result = orderLoader.createOrder(2L, 1L, 1000L, 100L, 900L);
    ...
    class CreateOrderProductTests {
        ...
        void createOrderProduct_성공() {
            ...
            // when
            orderLoader.createOrderProduct(orderId, orderProducts);
