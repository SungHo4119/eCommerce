...
public class ProductLoaderTest {
    ...
    class GetProductsTests {
        ...
        void getProductList_성공() {
            ...
            // when
            List<Product> result = productLoader.getProductList();
            // then
    ...
    class CheckGetProductListTests {
        ...
        void checkGetProductList_성공() {
            ...
            // when
            List<Product> result = productLoader.checkGetProductList(productIds);
            // then
            assertEquals(productList, result);
        }
    }
    ...
    class GetProductQuantityListWithLockTests {
        ...
        void getProductQuantityListWithLock() {
            ...
            when(productRepository.productQuantityFindByIdsWithLock(productIds)).thenReturn(
                productQuantityList);
            // when
            List<ProductQuantity> result = productLoader.getProductQuantityListWithLock(productIds);
            // then
    ...
    class ValidateProductQuantitiesTests {
        ...
        void PRODUCT_NOT_FOUND_ResourceNotFoundException() {
            ...
            ResourceNotFoundException exception = assertThrows(ResourceNotFoundException.class,
                () -> {
                    productLoader.validateProductQuantitie(orderProductList, productQuantityList);
                });
            // then
        ...
        void validateProductQuantitie_성공() {
            ...
            // when
            List<ProductQuantity> result = productLoader.validateProductQuantitie(orderProductList,
                productQuantityList);
            // then
            assertEquals(productQuantityList, result);
            // 재고 차감이 이루워졌는지 확인
    ...
    class SaveAllProductQuantityTests {
        ...
        void saveAllProductQuantity_성공() {
            ...
            // when & then
            productLoader.saveAllProductQuantity(productQuantities, products);
        }
    ...
    class CancelProductQuantityTests {
        ...
        void PRODUCT_NOT_FOUND_ResourceNotFoundException() {
            ...
            // when
            ResourceNotFoundException exception = assertThrows(ResourceNotFoundException.class,
                () -> productLoader.cancelProductQuantity(productQuantities, orderProductList));
            // then
            assertEquals(PRODUCT_NOT_FOUND, exception.getMessage());
        }
    ...
    class GetTopProductListTests {
        ...
        void function() {
            ...
            // when
            List<ProductTop> result = productLoader.getTopProductList(toDay);
            // then
